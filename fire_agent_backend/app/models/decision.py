...
class DecisionRun(Base):
    ...
    source_candidate_id: Mapped[str | None] = mapped_column(String(240), nullable=True, index=True)
    visual_case_id: Mapped[str | None] = mapped_column(String(180), nullable=True, index=True)
    confirmation_id: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
    spread_run_id: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
    spatial_analysis_id: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
